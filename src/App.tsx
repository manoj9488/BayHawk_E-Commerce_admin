...
import { ContactMessagesPage } from './pages/support/ContactMessagesPage';
import { JobOpeningsPage } from './pages/support/JobOpeningsPage';
import { JobApplicationsPage } from './pages/support/JobApplicationsPage';
import { ChatbotLogsPage } from './pages/support/ChatbotLogsPage';
import { NewsletterSubscriptionsPage } from './pages/support/NewsletterSubscriptionsPage';
  ...
  return (
    <RollbackProvider>
      <Routes>
        ...
        <Route path="hub/support/contact-messages" element={<ProtectedRouteComponent permission={PERMISSIONS.HUB_TEAM_MANAGE}><ContactMessagesPage /></ProtectedRouteComponent>} />
        <Route path="hub/support/job-openings" element={<ProtectedRouteComponent permission={PERMISSIONS.HUB_TEAM_MANAGE}><JobOpeningsPage /></ProtectedRouteComponent>} />
        <Route path="hub/support/job-applications" element={<ProtectedRouteComponent permission={PERMISSIONS.HUB_TEAM_MANAGE}><JobApplicationsPage /></ProtectedRouteComponent>} />
        <Route path="hub/support/chatbot" element={<ProtectedRouteComponent permission={PERMISSIONS.HUB_TEAM_MANAGE}><ChatbotLogsPage /></ProtectedRouteComponent>} />
        <Route path="hub/support/newsletter" element={<ProtectedRouteComponent permission={PERMISSIONS.HUB_TEAM_MANAGE}><NewsletterSubscriptionsPage /></ProtectedRouteComponent>} />
        ...
        <Route path="store/support/contact-messages" element={<ProtectedRouteComponent permission={PERMISSIONS.STORE_TEAM_MANAGE}><ContactMessagesPage /></ProtectedRouteComponent>} />
        <Route path="store/support/job-openings" element={<ProtectedRouteComponent permission={PERMISSIONS.STORE_TEAM_MANAGE}><JobOpeningsPage /></ProtectedRouteComponent>} />
        <Route path="store/support/job-applications" element={<ProtectedRouteComponent permission={PERMISSIONS.STORE_TEAM_MANAGE}><JobApplicationsPage /></ProtectedRouteComponent>} />
        <Route path="store/support/chatbot" element={<ProtectedRouteComponent permission={PERMISSIONS.STORE_TEAM_MANAGE}><ChatbotLogsPage /></ProtectedRouteComponent>} />
        <Route path="store/support/newsletter" element={<ProtectedRouteComponent permission={PERMISSIONS.STORE_TEAM_MANAGE}><NewsletterSubscriptionsPage /></ProtectedRouteComponent>} />
        ...
        <Route path="support/contact-messages" element={<ContactMessagesPage />} />
        <Route path="support/job-openings" element={<JobOpeningsPage />} />
        <Route path="support/job-applications" element={<JobApplicationsPage />} />
        <Route path="support/chatbot" element={<ChatbotLogsPage />} />
        <Route path="support/newsletter" element={<NewsletterSubscriptionsPage />} />
