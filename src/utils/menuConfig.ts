...
export const HUB_MENU: MenuItem[] = [
  ...
  },
  {
    ...
    label: "Support",
    icon: LifeBuoy,
    path: "/hub/support/contact-messages",
    module: "hub",
    requiredRoles: ["hub_main_admin"],
    children: [
      {
        id: "hub-support-contact",
      ...
      {
        id: "hub-support-openings",
        label: "Job Openings",
        icon: null,
        path: "/hub/support/job-openings",
        module: "hub",
        requiredRoles: ["hub_main_admin"],
      },
      {
        id: "hub-support-applications",
        label: "Job Applications",
        icon: null,
        path: "/hub/support/job-applications",
        module: "hub",
        requiredRoles: ["hub_main_admin"],
      },
      {
        id: "hub-support-chatbot",
        label: "Chatbot Logs",
        icon: null,
        path: "/hub/support/chatbot",
        module: "hub",
        requiredRoles: ["hub_main_admin"],
      },
      {
        id: "hub-support-newsletter",
        label: "Newsletter",
        icon: null,
        path: "/hub/support/newsletter",
        module: "hub",
        requiredRoles: ["hub_main_admin"],
      },
    ],
...
export const STORE_MENU: MenuItem[] = [
  ...
  },
  {
    ...
    label: "Support",
    icon: LifeBuoy,
    path: "/store/support/contact-messages",
    module: "store",
    requiredRoles: ["store_main_admin"],
    children: [
      {
        id: "store-support-contact",
        label: "Contact Messages",
        icon: null,
        path: "/store/support/contact-messages",
        module: "store",
      ...
      {
        id: "store-support-openings",
        label: "Job Openings",
        icon: null,
        path: "/store/support/job-openings",
        module: "store",
        requiredRoles: ["store_main_admin"],
      },
      {
        id: "store-support-applications",
        label: "Job Applications",
        icon: null,
        path: "/store/support/job-applications",
        module: "store",
        requiredRoles: ["store_main_admin"],
      },
      {
        id: "store-support-chatbot",
        label: "Chatbot Logs",
        icon: null,
        path: "/store/support/chatbot",
        module: "store",
        requiredRoles: ["store_main_admin"],
      },
      {
        id: "store-support-newsletter",
        label: "Newsletter",
        icon: null,
        path: "/store/support/newsletter",
        module: "store",
        requiredRoles: ["store_main_admin"],
      },
    ],
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: "Job Openings",
        icon: null,
        path: "/support/job-openings",
        module: "both",
      },
      {
        id: "support-applications",
        label: "Job Applications",
        icon: null,
        path: "/support/job-applications",
        module: "both",
      },
      {
        id: "support-chatbot",
