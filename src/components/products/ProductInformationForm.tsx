...
import { Card } from '../ui';
import type { ProductCategoryOption } from '../../utils/productBackend';
...
export function ProductInformationForm({
  ...
  const isFishCategory = () => {
    const selectedCategory = availableCategories.find(cat => cat.id === data.category);
    return selectedCategory?.moduleScope === 'hub';
  };
