...
function StoreProvider({ children }) {
    ...
    const [teamMembers, setTeamMembers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTeamMembers"]);
    const [coupons, setCoupons] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockCoupons"]);
    ...
    const [deliveryAgents, setDeliveryAgents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialDeliveryAgents);
    ...
    const [deliverySlots, setDeliverySlots] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialDeliverySlots);
    const [auditLogs, setAuditLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialAuditLogs);
    const [stockMovements, setStockMovements] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [dashboardStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockDashboardStats"]);
    // Helper to add audit log
    const addAuditLog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addAuditLog]": (log)=>{
            const newLog = {
                ...log,
                id: `audit-${Date.now()}`,
                timestamp: new Date(),
            ...
            setAuditLogs({
                "StoreProvider.useCallback[addAuditLog]": (prev)=>[
                        newLog,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addAuditLog]"]);
        }
    }["StoreProvider.useCallback[addAuditLog]"], []);
    // Order actions
    const addOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addOrder]": (order)=>{
            setOrders({
                "StoreProvider.useCallback[addOrder]": (prev)=>[
                        order,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addOrder]"]);
            addAuditLog({
    ...
    const updateOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateOrder]": (id, updates)=>{
            setOrders({
                "StoreProvider.useCallback[updateOrder]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateOrder]": (order)=>order.id === id ? {
                                ...order,
                                ...updates,
                                updatedAt: new Date().toISOString()
                            } : order
                    }["StoreProvider.useCallback[updateOrder]"])
            }["StoreProvider.useCallback[updateOrder]"]);
        }
    }["StoreProvider.useCallback[updateOrder]"], []);
    const deleteOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[deleteOrder]": (id)=>{
            setOrders({
                "StoreProvider.useCallback[deleteOrder]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[deleteOrder]": (order)=>order.id !== id
                    }["StoreProvider.useCallback[deleteOrder]"])
            }["StoreProvider.useCallback[deleteOrder]"]);
        }
    }["StoreProvider.useCallback[deleteOrder]"], []);
    // Product actions
    ...
    const updateProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateProduct]": (id, updates)=>{
            setProducts({
                "StoreProvider.useCallback[updateProduct]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateProduct]": (product)=>product.id === id ? {
                                ...product,
                                ...updates
                            } : product
    ...
    const deleteProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[deleteProduct]": (id)=>{
            const product = products.find({
                "StoreProvider.useCallback[deleteProduct].product": (p)=>p.id === id
            }["StoreProvider.useCallback[deleteProduct].product"]);
            setProducts({
                "StoreProvider.useCallback[deleteProduct]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[deleteProduct]": (p)=>p.id !== id
    ...
    // Team member actions
    const addTeamMember = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addTeamMember]": (member)=>{
            setTeamMembers({
                "StoreProvider.useCallback[addTeamMember]": (prev)=>[
                        member,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addTeamMember]"]);
            addAuditLog({
    ...
    const updateTeamMember = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateTeamMember]": (id, updates)=>{
            setTeamMembers({
                "StoreProvider.useCallback[updateTeamMember]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateTeamMember]": (member)=>member.id === id ? {
                                ...member,
                                ...updates
                            } : member
                    }["StoreProvider.useCallback[updateTeamMember]"])
            }["StoreProvider.useCallback[updateTeamMember]"]);
        }
    }["StoreProvider.useCallback[updateTeamMember]"], []);
    const deleteTeamMember = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[deleteTeamMember]": (id)=>{
            setTeamMembers({
                "StoreProvider.useCallback[deleteTeamMember]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[deleteTeamMember]": (member)=>member.id !== id
                    }["StoreProvider.useCallback[deleteTeamMember]"])
            }["StoreProvider.useCallback[deleteTeamMember]"]);
        }
    }["StoreProvider.useCallback[deleteTeamMember]"], []);
    // Coupon actions
    const addCoupon = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addCoupon]": (coupon)=>{
            setCoupons({
                "StoreProvider.useCallback[addCoupon]": (prev)=>[
                        coupon,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addCoupon]"]);
            addAuditLog({
    ...
    const updateCoupon = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateCoupon]": (id, updates)=>{
            setCoupons({
                "StoreProvider.useCallback[updateCoupon]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateCoupon]": (coupon)=>coupon.id === id ? {
                                ...coupon,
                                ...updates
                            } : coupon
                    }["StoreProvider.useCallback[updateCoupon]"])
            }["StoreProvider.useCallback[updateCoupon]"]);
        }
    }["StoreProvider.useCallback[updateCoupon]"], []);
    const deleteCoupon = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[deleteCoupon]": (id)=>{
            setCoupons({
                "StoreProvider.useCallback[deleteCoupon]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[deleteCoupon]": (coupon)=>coupon.id !== id
                    }["StoreProvider.useCallback[deleteCoupon]"])
            }["StoreProvider.useCallback[deleteCoupon]"]);
        }
    }["StoreProvider.useCallback[deleteCoupon]"], []);
    // Hub actions
    const addHub = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addHub]": (hub)=>{
            setHubs({
                "StoreProvider.useCallback[addHub]": (prev)=>[
                        hub,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addHub]"]);
        }
    }["StoreProvider.useCallback[addHub]"], []);
    const updateHub = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateHub]": (id, updates)=>{
            setHubs({
                "StoreProvider.useCallback[updateHub]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateHub]": (hub)=>hub.id === id ? {
                                ...hub,
                                ...updates
                            } : hub
                    }["StoreProvider.useCallback[updateHub]"])
            }["StoreProvider.useCallback[updateHub]"]);
        }
    }["StoreProvider.useCallback[updateHub]"], []);
    const deleteHub = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[deleteHub]": (id)=>{
            setHubs({
                "StoreProvider.useCallback[deleteHub]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[deleteHub]": (hub)=>hub.id !== id
                    }["StoreProvider.useCallback[deleteHub]"])
            }["StoreProvider.useCallback[deleteHub]"]);
        }
    }["StoreProvider.useCallback[deleteHub]"], []);
    // Customer actions
    const addCustomer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addCustomer]": (customer)=>{
            setCustomers({
                "StoreProvider.useCallback[addCustomer]": (prev)=>[
                        customer,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addCustomer]"]);
        }
    }["StoreProvider.useCallback[addCustomer]"], []);
    const updateCustomer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateCustomer]": (id, updates)=>{
            setCustomers({
                "StoreProvider.useCallback[updateCustomer]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateCustomer]": (c)=>c.id === id ? {
                                ...c,
                                ...updates
                            } : c
                    }["StoreProvider.useCallback[updateCustomer]"])
            }["StoreProvider.useCallback[updateCustomer]"]);
        }
    }["StoreProvider.useCallback[updateCustomer]"], []);
    const deleteCustomer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[deleteCustomer]": (id)=>{
            setCustomers({
                "StoreProvider.useCallback[deleteCustomer]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[deleteCustomer]": (c)=>c.id !== id
                    }["StoreProvider.useCallback[deleteCustomer]"])
            }["StoreProvider.useCallback[deleteCustomer]"]);
        }
    }["StoreProvider.useCallback[deleteCustomer]"], []);
    // Delivery Agent actions
    const addDeliveryAgent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addDeliveryAgent]": (agent)=>{
            setDeliveryAgents({
                "StoreProvider.useCallback[addDeliveryAgent]": (prev)=>[
                        agent,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addDeliveryAgent]"]);
        }
    }["StoreProvider.useCallback[addDeliveryAgent]"], []);
    const updateDeliveryAgent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateDeliveryAgent]": (id, updates)=>{
            setDeliveryAgents({
                "StoreProvider.useCallback[updateDeliveryAgent]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateDeliveryAgent]": (a)=>a.id === id ? {
                                ...a,
                                ...updates
                            } : a
                    }["StoreProvider.useCallback[updateDeliveryAgent]"])
            }["StoreProvider.useCallback[updateDeliveryAgent]"]);
        }
    }["StoreProvider.useCallback[updateDeliveryAgent]"], []);
    const deleteDeliveryAgent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[deleteDeliveryAgent]": (id)=>{
            setDeliveryAgents({
                "StoreProvider.useCallback[deleteDeliveryAgent]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[deleteDeliveryAgent]": (a)=>a.id !== id
                    }["StoreProvider.useCallback[deleteDeliveryAgent]"])
            }["StoreProvider.useCallback[deleteDeliveryAgent]"]);
        }
    }["StoreProvider.useCallback[deleteDeliveryAgent]"], []);
    ...
    const addNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addNotification]": (notification)=>{
            setNotifications({
                "StoreProvider.useCallback[addNotification]": (prev)=>[
                        notification,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addNotification]"]);
        }
    }["StoreProvider.useCallback[addNotification]"], []);
    const updateNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateNotification]": (id, updates)=>{
            setNotifications({
                "StoreProvider.useCallback[updateNotification]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateNotification]": (n)=>n.id === id ? {
                                ...n,
                                ...updates
                            } : n
                    }["StoreProvider.useCallback[updateNotification]"])
            }["StoreProvider.useCallback[updateNotification]"]);
        }
    }["StoreProvider.useCallback[updateNotification]"], []);
    const deleteNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[deleteNotification]": (id)=>{
            setNotifications({
                "StoreProvider.useCallback[deleteNotification]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[deleteNotification]": (n)=>n.id !== id
                    }["StoreProvider.useCallback[deleteNotification]"])
            }["StoreProvider.useCallback[deleteNotification]"]);
        }
    }["StoreProvider.useCallback[deleteNotification]"], []);
    // Delivery Slot actions
    const addDeliverySlot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addDeliverySlot]": (slot)=>{
            setDeliverySlots({
                "StoreProvider.useCallback[addDeliverySlot]": (prev)=>[
                        slot,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addDeliverySlot]"]);
            addAuditLog({
    ...
    const updateDeliverySlot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateDeliverySlot]": (id, updates)=>{
            setDeliverySlots({
                "StoreProvider.useCallback[updateDeliverySlot]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateDeliverySlot]": (slot)=>slot.id === id ? {
                                ...slot,
                                ...updates
                            } : slot
                    }["StoreProvider.useCallback[updateDeliverySlot]"])
            }["StoreProvider.useCallback[updateDeliverySlot]"]);
        }
    }["StoreProvider.useCallback[updateDeliverySlot]"], []);
    const deleteDeliverySlot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[deleteDeliverySlot]": (id)=>{
            setDeliverySlots({
                "StoreProvider.useCallback[deleteDeliverySlot]": (prev)=>prev.filter({
                        "StoreProvider.useCallback[deleteDeliverySlot]": (slot)=>slot.id !== id
                    }["StoreProvider.useCallback[deleteDeliverySlot]"])
            }["StoreProvider.useCallback[deleteDeliverySlot]"]);
        }
    }["StoreProvider.useCallback[deleteDeliverySlot]"], []);
    // Restore audit log
    const restoreAuditLog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[restoreAuditLog]": (id)=>{
            const log = auditLogs.find({
                "StoreProvider.useCallback[restoreAuditLog].log": (l)=>l.id === id
            }["StoreProvider.useCallback[restoreAuditLog].log"]);
            if (log) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Restored: ${log.entityName}`);
                setAuditLogs({
                    "StoreProvider.useCallback[restoreAuditLog]": (prev)=>prev.map({
                            "StoreProvider.useCallback[restoreAuditLog]": (l)=>l.id === id ? {
                                    ...l,
                                    canRestore: false
                                } : l
                        }["StoreProvider.useCallback[restoreAuditLog]"])
                }["StoreProvider.useCallback[restoreAuditLog]"]);
            }
        }
    }["StoreProvider.useCallback[restoreAuditLog]"], [
    ...
    // Stock movement
    const addStockMovement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[addStockMovement]": (movement)=>{
            const newMovement = {
                ...movement,
                id: `MOV-${Date.now()}`,
                timestamp: new Date()
            ...
            setStockMovements({
                "StoreProvider.useCallback[addStockMovement]": (prev)=>[
                        newMovement,
                        ...prev
                    ]
            }["StoreProvider.useCallback[addStockMovement]"]);
        }
    }["StoreProvider.useCallback[addStockMovement]"], []);
    const updateProductStock = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoreProvider.useCallback[updateProductStock]": (productId, quantity, type)=>{
            setProducts({
                "StoreProvider.useCallback[updateProductStock]": (prev)=>prev.map({
                        "StoreProvider.useCallback[updateProductStock]": (product)=>{
                    ...
                    }["StoreProvider.useCallback[updateProductStock]"])
            }["StoreProvider.useCallback[updateProductStock]"]);
        }
    }["StoreProvider.useCallback[updateProductStock]"], []);
    const value = {
...
_s(StoreProvider, "cQlxGZbvArvqm+7jFeFqjcnDz8Y=");
_c = StoreProvider;
function useStore() {
    _s1();
...
//# sourceMappingURL=_46c9255e._.js.map